...
admin=["uac087f23d43de7feb84d0d3893d0786c","u879cb13ff59f65af9168cc1cdf26d2d0"]
creator=["u879cb13ff59f65af9168cc1cdf26d2d0"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"This Bot Created Bye : line://ti/p/~tobyg74",
    "lang":"JP",
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
				...
				if msg.from_ in admin:
					...
					msg.text = None
					cl.sendMessage(msg)
            elif msg.text in ["æ„âﾄ1ﾤ7ﾺã®ãƒâﾄ1ﾤ7ﾔãƒ¬ãâﾄ1ﾤ7ﾚ¼ãƒ³ãƒ˄1ﾤ7","Cv1 gift"]:
				if msg.from_ in admin:
					msg.contentType = 9
					msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
										'PRDTYPE': 'THEME',
					...
					msg.text = None
					ki.sendMessage(msg)
            elif msg.text in ["æ„âﾄ1ﾤ7ﾺã®ãƒâﾄ1ﾤ7ﾔãƒ¬ãâﾄ1ﾤ7ﾚ¼ãƒ³ãƒ˄1ﾤ7","Cv2 gift"]:
				if msg.from_ in admin:
					msg.contentType = 9
					msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
										'PRDTYPE': 'THEME',
					...
					msg.text = None
					kk.sendMessage(msg)
            elif msg.text in ["æ„âﾄ1ﾤ7ﾺã®ãƒâﾄ1ﾤ7ﾔãƒ¬ãâﾄ1ﾤ7ﾚ¼ãƒ³ãƒ˄1ﾤ7","Cv3 gift"]:
				if msg.from_ in admin:
					msg.contentType = 9
					msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
										'PRDTYPE': 'THEME',
              ...
              if msg.from_ in admin:
                ...
                for target in targets:
                   try:
                      ...
                      pass
#--------------------------------------------
            elif "Info Contact" in msg.text:
                    contact = gas.getContact(msg.to)
                    cu = gas.channel.getCover(msg.to)
                    try:
                        gas.bagas(cinta,"[profilePicture]\nhttp://dl.profile.line-cdn.net/" + contact.pictureStatus + "\n[homePicture]\n" + str(cu))
                    except:
                        gas.bagas(cinta,"\n[homePicture]\n" + str(cu))    
#--------------------------------------------
...
#-----------------------------------------------
					...
					msg.contentType = 13
					msg.contentMetadata = {'mid': "u516346fef074e7a0cbd9a48221e18f0c"}
					cl.sendMessage(msg)
#-----------------------------------------------
